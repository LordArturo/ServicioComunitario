...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-05-2017 a las 07:05:27
...
--
CREATE DATABASE IF NOT EXISTS `consejocomunalgramalote` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `consejocomunalgramalote`;
...
--
ALTER TABLE `act_comercial`
  MODIFY `COD_ACT_COM` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `estado_civil`
  MODIFY `COD_EST_CIV` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `ingresos_clasif`
  MODIFY `COD_ING_FAM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `nivel_instruccion`
--
ALTER TABLE `nivel_instruccion`
  MODIFY `COD_NIV_INST` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `profesion`
  MODIFY `COD_PROFESION` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tipo_trabajo`
  MODIFY `COD_TIP_TRAB` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `vivienda`
  MODIFY `COD_VIVIENDA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
